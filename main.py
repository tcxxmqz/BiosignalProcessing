...
if __name__ == "__main__":
    ...
    fnirs_filepath = [r"C:\Python Files\BiosignalProcessing\data\1\fnirs\exper1.csv",
                      r"C:\Python Files\BiosignalProcessing\data\2\fnirs\exper2.csv",
                      r"C:\Python Files\BiosignalProcessing\data\3\fnirs\exper3.csv",
                      r"C:\Python Files\BiosignalProcessing\data\4\fnirs\exper4.csv",
                      r"C:\Python Files\BiosignalProcessing\data\5\fnirs\exper5.csv"]
